...
int main() {
  ...
  int total_hours_on_assignments;
  int total_lines_of_code;
  total_hours_on_assignments = hours_per_assignment * num_assignments;

  // Calculate the total number of lines of code written on assignments.
  num_assignments = 16;
  lines_per_assignment = 45;
  total_lines_of_code = num_assignments * hours_per_assignment;
